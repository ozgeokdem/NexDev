...
namespace PA.NexDev.Areas.ManagementArea.Controllers
{
    ...
    public class HomePageProjectController : Controller
    {
        ...
        public HomePageProjectController(NexDevDbContext context, IWebHostEnvironment env)
        {
            _context = context;
            _env = env;
        }
        ...
        {
            Guid? id = _context.HomePages.FirstOrDefault()?.Id;
            var model = await _context
                .ProjectItems
                .AsNoTracking()
                .Where(x => x.HomePageId == id)
                .ToListAsync();
        ...
        public async Task<IActionResult> Create(ProjectItem model, IFormFile img)
        {
            ...
            model.HomePageId = _context.HomePages.FirstOrDefault()?.Id;
